function [parCoordB,uv_B2A_refB,resultDisp,resultDefGrad,track_A2B,track_B2A,matchRatio] = fun_SerialTrack_2D_HardPar(...
    ImgSeqNum,defImg,brightfield_image,beadPara,MPTPara,parCoordA,parCoordB_prev,uv_B2A_refB_prev,plot_vectors)
...
%       plot_vectors        Show vector plot after computing displacements 
%
...
% x{1}{ImgSeqNum} = radial2center(currImg2_norm,x_,beadPara);
% x{1}{ImgSeqNum} = funLocalizeParticles(currImg2_norm,bw_img,beadPara); 
x{1}{ImgSeqNum} = x_;
...
[matches_A2B,u_B2A_curr_refB,track_A2B,matchRatio] = f_track_serial_match2D( parCoordA, parCoordB, ...
